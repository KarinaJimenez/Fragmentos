...
class PrimerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val Btn = vista.findViewById(R.id.BtnFragment1) as Button
        BtnFragment1.setOnClickListener{ Toast.makeText(activity, "Hola desde el fragment",Toast.LENGTH_LONG).show()
